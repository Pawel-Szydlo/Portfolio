...
export const projects: Project[] = [
  { slug: "nightly-extension", index: "01", title: "Nightly Extension", type: "Browser extension · Wallet UX", description: "A production Chrome and Firefox extension for wallet management, assets, transactions and blockchain integrations.", fullDescription: "A multichain wallet extension where clarity and trust matter at every step. I worked across wallet UX, extension constraints, API integrations and the component system behind the product.", tags: ["React", "TypeScript", "Tailwind CSS", "Storybook", "Playwright"], accent: "lime", href: "https://chromewebstore.google.com/detail/nightly/fiikommddbeccaoicoejoniammnalkfa?hl=en", linkLabel: "View on Chrome Web Store", role: "Senior Frontend Engineer & Team Lead", highlights: ["Browser extension used by approximately 300k users", "Coordinated a team of 6 developers across concurrent workstreams", "Improved responsive UI, accessibility, error states and maintainability"], approach: ["Reworked component structure and shared UI patterns for consistency across wallet flows.", "Partnered with product, design and backend engineers on API behavior, authentication and product decisions.", "Supported Playwright E2E testing, release readiness and secure UX review."], media: PROJECT_MEDIA["nightly-extension"] },
  { slug: "nightly-mobile", index: "02", title: "Nightly Mobile", type: "React Native · Mobile product", description: "A cross-platform cryptocurrency wallet focused on clear account flows, transactions and multichain usage.", fullDescription: "A mobile wallet for managing assets across multiple chains. The work combined product coordination, responsive mobile UI quality, API error handling and release readiness.", tags: ["React Native", "TypeScript", "Redux", "REST APIs"], accent: "blue", href: "https://apps.apple.com/us/app/nightly-multichain-wallet/id6444768157", linkLabel: "View on App Store", role: "Senior Frontend Engineer & Team Lead", highlights: ["Cross-platform wallet for iOS and Android", "Account, transaction and multichain flows", "Developer coordination, testing and release support"], approach: ["Kept complex wallet states understandable through explicit flows and resilient loading and error states.", "Worked with the team on implementation decisions and consistent responsive behavior across mobile screens.", "Improved maintainability through shared patterns, typed data and focused code review."], media: PROJECT_MEDIA["nightly-mobile"] },
  { slug: "synthify", index: "03", title: "Synthify", type: "React · DeFi product", description: "A DeFi interface I built for staking, exchange, vaults and statistics, powered by external API and blockchain data.", fullDescription: "I built the frontend experience for a DeFi product covering staking, exchange, vaults and statistics. Beyond the UI, I implemented the product logic that connected user actions with external APIs and changing blockchain data.", tags: ["React", "TypeScript", "REST APIs", "Data UX"], accent: "peach", role: "Frontend Engineer", highlights: ["Built core frontend flows for staking, exchange, vaults and statistics", "Implemented product logic for balances, rates, validation and transaction states", "Integrated external APIs and blockchain data into responsive interfaces"], approach: ["Translated complex DeFi concepts into clear flows with useful validation and predictable feedback.", "Connected exchange, staking and vault views to external data while handling loading, error and empty states.", "Built responsive dashboard layouts and data visualisations around changing market and account information."], media: PROJECT_MEDIA.synthify },
];
